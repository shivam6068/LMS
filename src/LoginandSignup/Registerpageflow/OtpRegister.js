...
import '../Loginpageflow/loginpage.css'
import './OtpRegister.css';
import send from './image/send.png';
import error from './image/error.png';
import Otp from '../Loginpageflow/Component/Otp';
     ...
     <div className='Maindiv6'>
      <div className="lgpg-pagecontainer">
        ...
        <div>
            ...
            <span className="heading" style={{textAlign:'center',fontWeight:'bolder'}}>OTP Verification</span>
          {time > 0 && clicked === false ? (
            ...
            <div className="timeoutmessage">
              ...
              <span className="otperrormessagespan">
                Time limit exceeded for OTP entry. Please click on 'Resend OTP'
            ...
            <div className="otpmessage">
              <img src={send}></img>
              <span className="otpmessagespan">
                A new OTP has been successfully sent to your email. Please check
                your inbox.
              </span>
            </div>
          )}
          ...
          <Link to='/registersuccess'><button className="button">Verify</button></Link>
          ...
          <span className="heading2" >
            OTP expires in <span style={{ color: "red" }}>{time} sec</span>
          </span>
        </div>
      </div>
